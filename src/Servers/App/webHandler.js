...
const sitePagesConf ={
    ...
    '/QOG_boardGame.html':'src/Client/html/QOG_boardGame.html',
    '/en/actionsMenu.html':'src/Client/html/en/QOG_actionsMenu.html',
    '/fr/actionsMenu.html':'src/Client/html/fr/QOG_actionsMenu.html',
    '/A.html':'src/Client/html/games/EPT/A.html',
    '/index.css' : 'src/Client/css/index.css',
    '/actionMenu.css':'src/Client/css/games/QOG_actionMenu.css',
    ...
    '/eventManager.mjs':'src/Client/mjs/eventManager.mjs',
    '/scenario_default.json':'src/Client/json/games/QOG/scenario_default.json',
    '/EPT_scenario_default.json':'src/Client/json/games/EPT/EPT_scenario_default.json',
